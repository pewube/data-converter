<div class="container-sm">
    ...
    <form class="col-sm-12 col-md-10 offset-md-1 col-lg-6 offset-lg-3" action="" method="post" enctype="multipart/form-data">
        ...
        <div class="input-group py-2">
            ...
            <a class="d-block ms-3" data-bs-toggle="popover" data-bs-placement="top" data-bs-content="Po wczytaniu danych PrestaShop zaimportuje zdjęcia znajdujące się pod linkami, zapisze je w miejscu swojej instalacji i dostosuje zgodnie z wprowadzonymi ustawieniami. Zdjęcia będą znajdować się na serwerze, gdzie zainstalowany jest PrestaShop."><span class="material-symbols-outlined text-primary">help</span></a>
        </div>
        <div class="input-group py-2">
            <div class="form-check form-switch">
        ...
        <div class="input-group py-2">
            ...
            <a class="d-block ms-3" data-bs-toggle="popover" data-bs-placement="top" data-bs-content="Po zaznaczeniu tej opcji opisy zostaną skopiowane do PrestaShop razem ze stylami liniowymi, które dotyczą pogrubienia czcionek. Należy pamiętać o tym, że skopiowane zostaną jedynie style liniowe znajdujące się w opisach produktów w Shoperze."><span class="material-symbols-outlined text-primary">help</span></a>
        </div>
